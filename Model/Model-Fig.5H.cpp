...
//file name
string ccc="case-5H-8";
//real ry = 0.15;
//real rx = 0.15*0.030/ry;

//randomized angle
real angle=8.0*pi/18.0;
...
border b5(t=0,1){x=0+asp*0.5*cos(pi)+rx*cos(2*pi*t)*cos(angle)-ry*sin(2*pi*t)*sin(angle);y=1+0.5*sin(pi)+rx*cos(2*pi*t)*sin(angle)+ry*sin(2*pi*t)*cos(angle);label=Free;}
